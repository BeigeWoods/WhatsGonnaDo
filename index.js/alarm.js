const setTimeBox = document.querySelector(".STGContainer"),
timeBtn = setTimeBox.querySelectorAll(".time"),
alarmCont = document.querySelector(".alarmCont"),
alarmGrid = alarmCont.querySelector(".alarmGrid"),
alarmTime = alarmCont.querySelector(".alarmTime"),
alarmText = alarmCont.querySelector(".alarmText"),
ringBell = alarmCont.querySelector(".ringBell"),
configuration = document.querySelector(".configurationBody");
...
function ringAlarm(second, li){
    ...
    if(second === 0){
        ...
        alarmGrid.classList.add("shakeAlarmBox")
    } 
    else if (second > 0){
