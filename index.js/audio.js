...
audio = audioBox.querySelector(".audio"),
controller = audioBox.querySelector(".controller"),
controllIcon = controller.querySelector(".controllIcon"),
forward = audioBox.querySelector(".forward"),
replay = audioBox.querySelector(".replay"),
